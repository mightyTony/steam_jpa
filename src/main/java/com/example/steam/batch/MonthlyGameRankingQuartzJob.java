...
@Configuration
public class MonthlyGameRankingQuartzJob implements org.quartz.Job {
    private final JobLauncher jobLauncher;
    @Qualifier("monthlyGameRankingJob")
    private final Job monthlyGameRankingJob;

    public MonthlyGameRankingQuartzJob(JobLauncher jobLauncher, @Qualifier("monthlyGameRankingJob") Job monthlyGameRankingJob) {
        this.jobLauncher = jobLauncher;
        this.monthlyGameRankingJob = monthlyGameRankingJob;
    }
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        try {
            JobParameters params = new JobParametersBuilder()
                    ...
                    .toJobParameters();
            jobLauncher.run(monthlyGameRankingJob, params);
